...
global df
import pandas as pd
#df = pd.DataFrame(columns=["CarNum","TimeStamp"])
df = pd.DataFrame(columns=["CarNum"])
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or opt.save_crop or view_img:  # Add bbox to image
                        ...
                        plot_one_box(df,xyxy, im0, label=label, color=colors(c, True), line_thickness=opt.line_thickness)
